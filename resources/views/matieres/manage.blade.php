<x-app-layout>
    <style>
        /* Rendre la barre du haut semi-transparente UNIQUEMENT sur cette page */
                ...
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <div class="text-xs text-gray-600">
                            ...
                            <span class="text-gray-900 font-semibold">Matières</span>
                        </div>
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        <a href="{{ route('dashboard') }}"
                           class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-white/90 border border-white/60 text-gray-800 hover:bg-white shadow-sm">
