<x-app-layout>
    <x-slot name="header">
        <div style="display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap;">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Modifier une matière</h2>
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('matieres.update', $matiereRow->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input name="nom" value="{{ old('nom', $matiereRow->nom) }}" class="w-full border rounded px-3 py-2" required>
                        </div>
